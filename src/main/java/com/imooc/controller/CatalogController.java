...
public class CatalogController {
	...
	//获取分类列表
	@GetMapping
	public String listCommnets(@RequestParam(value="username",required=true) String username,Model model){
		...
		if(SecurityContextHolder.getContext().getAuthentication()!=null && SecurityContextHolder.getContext().getAuthentication().isAuthenticated()
				&& SecurityContextHolder.getContext().getAuthentication().getAuthorities().toString().equals("anonymousUser")){
	...
	//创建分类
	@PostMapping
	@PreAuthorize("authention.name.equals(#catalogVo.username)")
